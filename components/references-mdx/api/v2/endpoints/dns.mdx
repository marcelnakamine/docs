...
| **updated**   | <HelpLink href="#api-basics/types">String</HelpLink>       | A timestamp with the date when the record was updated                                                           |
| **createdAt** | <HelpLink href="#api-basics/types">String</HelpLink>       | A timestamp with the date when the record was created.                                                          |
| **updatedAt** | <HelpLink href="#api-basics/types">String</HelpLink>       | A timestamp with the date when the record was updated                                                           |
