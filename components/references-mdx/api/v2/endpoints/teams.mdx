...
| **confirm** | <HelpLink href="#api-basics/types">Boolean</HelpLink>      | No       | Accept a user that requested access to the team.                  |
| **decline** | <HelpLink href="#api-basics/types">Boolean</HelpLink>      | No       | Prevent a user from joining the team or requesting access.        |
...
<Note>
  The authenticated user needs to be an <InlineCode>OWNER</InlineCode> in order to be able to successfully invoke this endpoint.
</Note>
